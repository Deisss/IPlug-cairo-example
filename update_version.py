...
def main():
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstCairoPlugin-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MyFirstCairoPlugin-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MyFirstCairoPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MyFirstCairoPlugin.iss",inplace=1):
